    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddAnime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                genres = Egenre.getText().toString();
                season = Eseason.getText().toString();
                nb_episodes = Eepisodes.getText().toString();
                ...
                Volley.newRequestQueue(AddAnime.this).add(jsonObjReq);
