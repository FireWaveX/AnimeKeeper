...
import org.ledeme.animekeeper.databinding.ContentAnimeListBinding;
...
public class ListOfAnime extends AppCompatActivity {
    ...
    Button btnAddAnime;
    ListOfAnimeMV.AnimeListAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListOfAnimeMV listOfAnimeMV = new ListOfAnimeMV();
        ((ContentAnimeListBinding) DataBindingUtil.setContentView(this, R.layout.content_anime_list))
                .setLoginVM(listOfAnimeMV);
        ...
        mAdapter = new ListOfAnimeMV.AnimeListAdapter(data);
    ...
    public static void MVVM_click(){
        ...
        final Intent addAnime = new Intent(mContext, AddAnime.class);
        mContext.startActivity(addAnime);
    ...
    public class AnimeUpdate extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent){
            ...
            ListOfAnimeMV.AnimeListAdapter adapter = (ListOfAnimeMV.AnimeListAdapter) rv_animeList.getAdapter();
